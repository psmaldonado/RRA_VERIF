function [U V W PSFC QVAPOR HGT RAINC RAINNC GEOPT HEIGHT TK RH ...
 RH2 U10M V10M SLP MCAPE MCIN]=read_arwpost_controlforecast_sfflux(file,nx,ny,nz) 
...
%          TSK(TSK>1e15)=NaN;
         ...
         HFX_FACTOR(HFX_FACTOR>1e15)=NaN;
         QFX_FACTOR(:,:)=fread(nfile,[nx ny],'single')';
         QFX_FACTOR(QFX_FACTOR>1e15)=NaN;
         UST_FACTOR(:,:)=fread(nfile,[nx ny],'single')';
         UST_FACTOR(UST_FACTOR>1e15)=NaN;
