...
load('../copy/SENSITIVITY_FLUX_TYPHOON/cost_function_hfx.mat','XLONG','XLAT');
...
subplot(1,3,1)
 ...
 pcolor(XLONG,XLAT,ERROR(1).BIASQ(:,:,LEV,1))
 axis([min(min(XLONG)) max(max(XLONG)) min(min(XLAT)) max(max(XLAT))])
 caxis(5e-4*[-2 2])
 title('CONTROL')
 colorbar
 shading flat
subplot(1,3,2)
 hold on
 pcolor(XLONG,XLAT,ERROR(2).BIASQ(:,:,LEV,1))
 plot(long,lat,'-k','LineWidth',2)
 axis([min(min(XLONG)) max(max(XLONG)) min(min(XLAT)) max(max(XLAT))])
 caxis(5e-4*[-2 2])
 shading flat
...
subplot(1,3,3)
 hold on
 pcolor(XLONG,XLAT,ERROR(3).BIASQ(:,:,LEV,1))
 plot(long,lat,'-k','LineWidth',2)
 axis([min(min(XLONG)) max(max(XLONG)) min(min(XLAT)) max(max(XLAT))])
 caxis(5e-4*[-2 2])
 shading flat
...
subplot(1,3,1)
 hold on
 plot(long,lat,'-k','LineWidth',2)
 pcolor(XLONG,XLAT,ERROR(1).BIAST(:,:,LEV,1))
 axis([min(min(XLONG)) max(max(XLONG)) min(min(XLAT)) max(max(XLAT))])
 caxis([-2 2])
 title('CONTROL')
 colorbar
...
subplot(1,3,2)
 hold on
 pcolor(XLONG,XLAT,ERROR(2).BIAST(:,:,LEV,1))
 plot(long,lat,'-k','LineWidth',2)
 axis([min(min(XLONG)) max(max(XLONG)) min(min(XLAT)) max(max(XLAT))])
 caxis([-2 2])
 shading flat
...
subplot(1,3,3)
 hold on
 pcolor(XLONG,XLAT,ERROR(3).BIAST(:,:,LEV,1))
 plot(long,lat,'-k','LineWidth',2)
 axis([min(min(XLONG)) max(max(XLONG)) min(min(XLAT)) max(max(XLAT))])
 caxis([-2 2])
 shading flat
