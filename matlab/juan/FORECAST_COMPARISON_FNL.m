...
load ([pathf '/FORECAST_EXP_40mem_sfflux_ntpar_smooth_fixparinf0.05_qfxhfx/verification_fnl/rmse_bias.mat' ]);
...
% load ([pathf '/FORECAST_EXP_40mem_sfflux_ntpar_smooth_fixparinf0.05_qfxust/verification_fnl/rmse_bias.mat' ]);
% 
% ERROR(4).BIASH=BIASH;
% ERROR(4).BIASQ=BIASQ;
% ERROR(4).BIASSLP=BIASSLP;
% ERROR(4).BIAST=BIAST;
% ERROR(4).BIASU=BIASU;
% ERROR(4).BIASV=BIASV;
% ERROR(4).RMSEH=RMSEH;
% ERROR(4).RMSEQ=RMSEQ;
% ERROR(4).RMSESLP=RMSESLP;
% ERROR(4).RMSET=RMSET;
% ERROR(4).RMSEU=RMSEU;
% ERROR(4).RMSEV=RMSEV;
...
pcolor(times,-log(PLEVS),RMSEM(iexp).T)
...
subplot(1,NFORECAST,iexp)
pcolor(times,-log(PLEVS),RMSEM(iexp).Q)
...
subplot(1,NFORECAST,iexp)
pcolor(times,-log(PLEVS),RMSEM(iexp).U)
...
subplot(1,NFORECAST,iexp)
pcolor(times,-log(PLEVS),RMSEM(iexp).V)
...
pcolor(times,-log(PLEVS),RMSEM(1).T-RMSEM(iexp+1).T)
...
subplot(1,NFORECAST-1,iexp)
pcolor(times,-log(PLEVS),RMSEM(1).Q-RMSEM(iexp+1).Q)
...
subplot(1,NFORECAST-1,iexp)
pcolor(times,-log(PLEVS),RMSEM(1).U-RMSEM(iexp+1).U)
...
subplot(1,NFORECAST-1,iexp)
pcolor(times,-log(PLEVS),RMSEM(1).V-RMSEM(iexp+1).V)
...
subplot(1,NFORECAST,iexp)
pcolor(times,-log(PLEVS),BIASM(iexp).T)
...
subplot(1,NFORECAST,iexp)
pcolor(times,-log(PLEVS),BIASM(iexp).Q)
...
subplot(1,NFORECAST,iexp)
pcolor(times,-log(PLEVS),BIASM(iexp).U)
...
subplot(1,NFORECAST,iexp)
pcolor(times,-log(PLEVS),BIASM(iexp).V)
...
subplot(1,NFORECAST-1,iexp)
pcolor(times,-log(PLEVS),BIASM(1).T-BIASM(iexp+1).T)
...
subplot(1,NFORECAST-1,iexp)
pcolor(times,-log(PLEVS),BIASM(1).Q-BIASM(iexp+1).Q)
...
subplot(1,NFORECAST-1,iexp)
pcolor(times,-log(PLEVS),BIASM(1).U-BIASM(iexp+1).U)
...
subplot(1,NFORECAST-1,iexp)
pcolor(times,-log(PLEVS),BIASM(1).V-BIASM(iexp+1).V)
