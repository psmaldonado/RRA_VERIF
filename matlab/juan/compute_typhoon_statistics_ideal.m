...
best_track_file='../TRUE_RUN_SINLAKU_CONSTANT_QFX0.8_60KM/trajectories/BestTrackNatureRun.mat';

PATH_EXPERIMENT{1}='../FORECAST_CONTROL40M_IDEAL_CONSTANTPAR0.8_MEMNC/';
PATH_EXPERIMENT{2}='../FORECAST_QFX0D40M_IDEAL_CONSTANTPAR0.8_MEMNC/';
...
%totaldisttrack=zeros(nexp,leadtime/timefrec+1);   %Location errors
...
if( sf == datenum('2008082512','yyyymmddHH') & strcmp(strtrim(CurrentTracks(it).name),'TYPHOON3') ) 
...
if( sf == datenum('2008090112','yyyymmddHH') & strcmp(strtrim(CurrentTracks(it).name),'TYPHOON4') ) 
...
save('Typhoon_statistics_ideal.mat','meandisttrack','stddisttrack','ndisttrack','Ejemplo2','Ejemplo1' ...
